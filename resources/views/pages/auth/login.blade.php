        ...
        <div class="max-w-md mx-auto">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <div class="text-right">
                    <a href="{{ route('password.request') }}" class="text-xs uppercase tracking-[0.15em] opacity-60 hover:opacity-100 underline">
                        Quên mật khẩu?
                    </a>
                </div>
            ...
            <div class="mt-8">
                <a
                    ...
                    class="block w-full py-3 border-2 border-black text-center text-black text-xs uppercase tracking-[0.2em] hover:bg-black hover:text-white transition-all"
                >
